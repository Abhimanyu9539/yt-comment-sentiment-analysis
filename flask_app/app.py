...
# The vectorizer is in the parent directory
vectorizer_path = os.path.join(current_dir, "..", "tfidf_vectorizer.pkl")

model, vectorizer = load_model_and_vectorizer(
    "yt_chrome_plugin_model", "1", vectorizer_path
...
def generate_chart():
    try:
        ...
        colors = ["green", "skyblue", "red"]  # Positive, Neutral, Negative
